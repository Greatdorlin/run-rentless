...
export function HomeStory() {
  return <>
    ...
    <section className="section story-cohort" id="cohort">
      <div className="shell"><p className="eyebrow"><span /> Learn to build with AI · Guided group programme</p><h2>Build the tools your business needs.<br />With AI. With guidance.</h2><p className="story-lead">Bring one or two people from your team. Learn to build an internal customer tracker, booking app or approval tool, even if you have never written code.</p>
      <div className="principle-grid"><article><span>01</span><h3>Start with a real business task.</h3><p>Choose a job your team already pays a tool to do. Decide what to keep and what is worth building.</p></article><article><span>02</span><h3>Build it with guidance.</h3><p>Learn how to give AI clear instructions, check its work and fix mistakes. Build a useful first version, not just a good-looking demo.</p></article><article><span>03</span><h3>Check it before your team relies on it.</h3><p>Practise testing, permissions and backups. Know who can see each record, how to recover it and when to bring in an expert.</p></article></div>
      <div className="story-split cohort-detail"><div><h3>A working screen is not a finished tool.</h3><p>AI can help you build quickly. But you still need to check the answers it gives, protect customer information and understand what you will pay to keep the tool running.</p></div><div><h3>Know the bills before you build.</h3><p>Learn to spot AI credits, hosting, storage and paid add-ons. Compare the full running cost with your subscription before deciding to switch.</p></div></div>
      <div className="story-action"><Link href="/#audit" className="button">Find My First Project <span aria-hidden="true">↗</span></Link><p>Start with the free audit. Ask about the next group after your results.</p></div>
      <p className="story-note">The aim is to reduce avoidable costs and give your team useful skills. Savings depend on your tools and what it takes to replace them.</p></div>
    </section>
    ...
    <section className="section story-questions"><div className="shell story-split"><div><p className="eyebrow"><span /> Before you start</p><h2>A few straight answers.</h2></div><div>
      ...
      <details><summary>Do I need a technical team?</summary><p>No. Our guided programme welcomes people with or without a technical background. If your team does not have time to learn and build, we can do the build for you.</p></details>
